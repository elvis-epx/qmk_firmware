...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( \
        ...
        KC_LCTL, KC_LALT, KC_LGUI,        LT(2, KC_SPC), LT(2, KC_SPC),         KC_SCLN,  KC_QUOT,  KC_MINS ),

    [1] = LAYOUT( \
        _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, \
        KC_LCTL, KC_LALT, KC_RCTL,        LT(2, KC_SPC), LT(2, KC_SPC),         KC_SCLN,  KC_QUOT,  KC_MINS ),
    ...
    [3] = LAYOUT( \
        ...
        _______, KC_F11,  KC_F12,  KC_APP,  _______, _______, _______, _______, _______,  TO(1),    _______, \
        _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______, TO(0),   _______,  KC_PGUP,  _______, \
