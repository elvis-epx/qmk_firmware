...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * Num Lock A toogles layer, so the numeric block works as a Model F navigation block even in a Mac.
   * Num Lock B works as a regular Num Lock, which is ignored by Mac but honored on PC.
   * Caps Lock operates normally but it takes FN to work, the key is Ctrl by default, like in Model F.
   * Seldom-used PC keys (Print Screen block) are media keys by default.
   */
	LAYOUT_hotswap(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, MO(2),
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          TO(1),   KC_NLCK, KC_PAST, KC_PMNS,
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RALT, KC_RCTL, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT),
   ...
   */
    ...
    * PC keys (Print Screen, Scroll Lock and Pause)
    * Arrow keys become Page Up, etc. just like a 60% keyboard
    * Num Lock B becomes numpad slash since it is in the same spot
    */

	LAYOUT_hotswap(
    MO(3),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MSTP, KC_MUTE, KC_MUTE, KC_PSCR, KC_SLCK, KC_PAUS, _______,
    _______, BL_TOGG, BL_DEC,  BL_INC,  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,           _______, KC_PSLS, _______, _______,
